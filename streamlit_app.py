...
def analyze_classes_from_prediction(report, final_report: bool | None = False):
    ...
    if final_report:
        ...
        hsil_rate = hsil / (lsil+normal)
        lsil_rate = lsil / (hsil+normal)
        normal_rate = normal / hsil + lsil
        print(hsil, lsil, normal)
        print(hsil_rate, lsil_rate, normal_rate)
        if hsil_rate >= (lsil_rate + normal_rate) :
        ...
        elif lsil_rate >= (hsil_rate + normal_rate):
